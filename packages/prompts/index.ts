...
تنسيق الرد (JSON) فقط ومطابق للهيكل التالي بالضبط:
{
  ...
  "score": 7, // درجة تقديرية من 0-10 يجب توفيرها دائماً في حالة FULL أو PARTIAL بناءً على المعطيات، و null فقط إذا كان NONE
  "scoreLabel": "7/10", // نص معبر عن الدرجة أو null فقط إذا كان NONE
  "sections": {
    "known": {
      "title": "✅ ما أعرفه",
...
export const VALIDATOR_AGENT_PROMPT = `أنت ValidatorAgent خبير في التدقيق والتحقق. مهمتك هي قراءة مخرجات الوكلاء الآخرين، والتأكد من إتمام التحليل بمنطقية، وكشف أي تناقضات، وتقديم رأي قاطع حول اكتمال التقييم. حلل الفكرة والمدخلات السابقة وتأكد من المنطق.
(يجب أن تعيد JSON بناءً على نفس الـ Schema المطلوبة)`;
