      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between w-full pointer-events-auto">
        ...
        <div className="glass rounded-full p-1 flex items-center border border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
          ...
          <button
            ...
            className="px-3 py-1.5 text-rose-500/50 hover:text-rose-400 hover:bg-rose-500/10 rounded-full transition-all ml-2"
            title="تسجيل خروج"
          >
            <LogOut size={16} />
          </button>
        ...
        <Link to="/" className="flex items-center gap-4 hover:opacity-80 transition-opacity">
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm font-black text-white tracking-widest">QOOM</span>
