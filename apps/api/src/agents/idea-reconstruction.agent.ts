...
- إذا النص يصف منتجاً أو خدمة أو فكرة ريادية مفهومة حتى لو باختصار شديد (مثلاً: "منصة ذكاء اصطناعي بـ 5 وكلاء ذكاء اصطناعي") -> تعتبر الفكرة CLEAR ويجب أن تكون درجة الوضوح (clarityScore) بين 50 و 100 بناءً على اكتمال التفاصيل.
...
1. المشكلة (problem): ما الاحتياج أو الألم؟ (مثال: "صعوبة تقييم الأفكار وحاجة المؤسس لقرار سريع ودقيق")
2. الحل (solution): ما المنتج أو الخدمة؟ (مثال: "منصة ذكاء اصطناعي لتقييم الأفكار")
3. الفئة المستهدفة (target_audience): من سيدفع أو يستخدم؟ (مثال: "رواد الأعمال والمؤسسون")
4. المنتج الأدنى (mvp): ما هي الميزة الأساسية المفترضة؟ (مثال: "تحليل فوري وتقييم للأفكار")
